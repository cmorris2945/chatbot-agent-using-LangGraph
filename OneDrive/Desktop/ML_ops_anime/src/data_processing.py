...
class DataProcessor:
    def __init__(self,input_file, output_dir):
        ...
        self.uder2user_encoded= {}
        self.user2user_decoded = {}
        self.anime2anime_encoded = {}
        self.anime2anime_decoded = {}

        os.makedirs(self.output_dir, exist_ok=True)
        logger.info("Dataprocessing has started...")
    
    def load_data(self, usecols):
        try:
            self.rating_df = pd.read_csv(self.input_file, low_memory=True, usecols=usecols)
            logger.info("Data loaded successfully for processing this stuff.")

        except Exception as e:
            raise CustomException("Failed to load data, asshole!", sys)
    ...
    def filter_users(self, min_rating=400):
        try:
            ...
            logger.info("Filtered users successfully you punk!")

        except Exception as e:
            raise CustomException("Failed to filter data jackack!", sys)
    ...
    def scale_ratings(self):
        try:
            ...
            logger.info("Scaling do for the the processing step.")
        except Exception as e:
            raise CustomException("Failed to scale the data for some reason.", sys)
    ...
    def encode_data(self):
        try: 
            ...
            logger.info("Encoding for the 'users' and the 'anime' data.")
        except Exception as e:
            raise CustomExceptio("Falied to encode data", sys)
    ...
    def save_artifacts(self):
        try:
            ...
            for name,data in artifacts.items():
                joblib.dump(data, os.path.join(self.output, f"{name}.pkl"))
                logger.info(f"{name} saved successfully in processed directory you punk!")
            ...
            logger.info("All the stupid traininf and testing as well as 'rating_df' data frame is daved now fool.")

        except Exception as e:
            raise CustomException("Failed to save artificats data. WHOOPS!", sys)
    ...
    def process_anime_data(self):
        ...
        try:
            ...
            logger.info("The DF and SYNOPSIS_DF stuff is saved now.")

        except Exception as e:
            raise CustomException("Failed to process your stupis 'anime' and 'anime_synopis' files.", sys)
    ...
    def run(self):
        try:
            ...
            logger.info("Data processing for your stupid pipeline has run successfully, surprisingly.")
